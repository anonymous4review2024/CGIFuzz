...
PIPE_FROM_GDBFuzz_FILE = '/tmp/fromCGIFuzz'
PIPE_TO_GDBFuzz_FILE = '/tmp/toCGIFuzz'
QEMU_COVERAGE_FILE = '/tmp/coverage_data'


qemu_command = "/qemu/build/x86_64-linux-user/qemu-x86_64 -d plugin -plugin /cgifuzz/src/qemu-plugins/libbbtrace.so "
